...
class LightningMcqueen:
    ...
    def lets_do_this_thing(self, map_to_fill):
        ...
        for coordinate in rec:
            ...
            if direction == 0 and move == "down":
                ...
                #TO-DO We need to look into this Why?
                self.turnLeft()
                self.turnLeft()
                self.move25()
                self.move25()
    ...
    def get_possible_moves(self, map_to_fill, current_coordinate):
        ...
        if (current_coordinate[0] + 1 < len(map_to_fill) and map_to_fill[
            int(current_coordinate[0]) + 1, current_coordinate[1]] != 1):
            possible_moves.append((current_coordinate[0] + 1, current_coordinate[1]))
        ...
        if (current_coordinate[1] + 1 < len(map_to_fill[0]) and map_to_fill[
            int(current_coordinate[0]), current_coordinate[1] + 1] != 1):
            possible_moves.append((current_coordinate[0], current_coordinate[1] + 1))
